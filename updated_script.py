############ BROK AI FIXED VERSION for Deployment v4.2 ########
...
def get_prompt(user_input, persona, history):
...
def generate_response(message, history, persona):
    prompt = get_prompt(message, persona, history)
